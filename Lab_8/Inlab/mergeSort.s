...
mergeSort:
	...
	cmp rsi, rdx        ; if (left >= right), jump to done
	jge done

	;calculating mid and storing variables
	mov r11, rdx 		; move right index into r11
	add r11, rsi 		; right + left
	shr r11, 1 			; r11/2 to find midpoint
	mov r12, rsi		; store left in r12
	mov r13, rdx 		; store right in r13

	mov rdx, r11        ; set mid as 3rd parameter
	;push rsi
	;push rdx
	...
	add r11, 1 			; mid += 1
	mov rsi, r11        ; set mid as 2nd parameter
	mov rdx, r13 		; reset right as 3rd parameter
	;push rsi
	;push rdx
	...
	mov rsi, r12 		; reset left as second parameter
	dec r11				; mid -= 1
	mov rdx, r11		; set midpoint as third parameter
	mov rcx, r13 		; set right as fourth parameter
