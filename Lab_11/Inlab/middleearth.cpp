...
/**
 * @brief Shuffles the itinerary
 * @param first Points to the beginning of a list of cities
 * @param last Points to the end of a list of cities
 * @param g A random number
 * 
 **/
